    ...
    def format_prompt(self, user_input):
        ...
        Example prompt format:
            "You are a helpful assistant that specializes in Boston schools...
             ...
             Assistant:"
        """
        prompt = f"""You are a helpful assistant that specializes in Boston schools. You should always provide accurate information, based ONLY on the SCHOOL RULES document below. 
...
Assistant:
    ...
    def get_response(self, user_input):
        ...
        output = self.pipeline(prompt, max_new_tokens=200, do_sample=True, temperature=0.7)
